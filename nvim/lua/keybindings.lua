...
-- custom_map("n", "<C-s>", ":source $HOME/.config/nvim/init.lua<CR>")
-- custom_map("n", "<leader>,v", ":vsplit $HOME/.config/nvim/init.lua<CR>")
-- custom_map("n", "<leader>,s", ":split $HOME/.config/nvim/init.lua<CR>")
